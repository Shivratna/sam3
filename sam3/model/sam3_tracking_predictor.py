...
class Sam3TrackerPredictor(Sam3TrackerBase):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.bf16_context = torch.autocast(device_type="cuda" if torch.cuda.is_available() else ("mps" if torch.backends.mps.is_available() else "cpu"), dtype=torch.bfloat16)
    ...
    def init_state(
        ...
        if offload_state_to_cpu:
            ...
            inference_state["storage_device"] = torch.device("cuda" if torch.cuda.is_available() else ("mps" if torch.backends.mps.is_available() else "cpu"))
