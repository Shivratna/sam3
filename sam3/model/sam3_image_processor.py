...
class Sam3Processor:
    ...
    def __init__(self, model, resolution=1008, device="cuda" if torch.cuda.is_available() else ("mps" if torch.backends.mps.is_available() else "cpu"), confidence_threshold=0.5):
        self.model = model
